    ...
    return (
        <aside className={styles.aside}>
            <nav className={styles.nav}>
                <Link href="/posters"><button className={styles.linkButton}>Alla</button></Link>
                <Link href="/posters/topplistan"><button className={styles.linkButton}>Topplistan</button></Link>
                <Link href="/posters/nyheter"><button className={styles.linkButton}>Nyheter</button></Link>
                {productCategories.map((category) => (
                    <Link href={`/posters/${category.categoryName}`} key={category.categoryId}><button className={styles.linkButton}>{capitalizeFirstLetter(category.categoryName)}</button></Link>
